...
/**
 * The LastFMRecommender class provides functionality to process Last.fm dataset
 * and perform various operations such as listing friends, finding common friends,
 * listing artists, listing top artists, and recommending artists.
 */
...
public class LastFMRecommender {
    ...
    /**
     * Constructs a LastFMRecommender object.
     * Initializes artistNames, userFriends, and userArtists maps.
     */
    ...
    /**
     * Loads data from provided files into the LastFMRecommender object.
     * 
     * @param artistsFile     The file containing information about music artists.
     * @param userArtistsFile The file containing artists listened by each user.
     * @param userFriendsFile The file containing friend relations between users.
     */
     ...
     * @throws IndexOutOfBoundsException If the user ID is invalid.
     */
